...
BBS+署名（[draft-irtf-cfrg-bbs-signatures-10](https://datatracker.ietf.org/doc/draft-irtf-cfrg-bbs-signatures/)、2026年1月）は、ペアリングフレンドリな楕円曲線（BLS12-381）ベースのZKP署名方式だ。
...
v2.0ではCL署名からBBS+署名への移行が検討されており、より効率的な失効管理スキームも計画されている。
...
AnonCreds v2.0がBBS+へ移行すれば、BBS+のエコシステムは大幅に広がる可能性がある。この動向は注視すべきだ。
...
- [Hyperledger AnonCreds Specification v1.0](https://hyperledger.github.io/anoncreds-spec/)
- [ISO/IEC 18013-5:2021 — Mobile Driver's License (mDL)](https://www.iso.org/standard/69084.html)
- [ISO/IEC TS 18013-7:2025 — mDL online presentation](https://www.iso.org/standard/82772.html)
