...
**Architecture Reference Framework（ARF）**は、EUDI Walletエコシステムの技術的「設計図」として機能し、現在バージョン2.4.0が公開されている（[ARF 2.4.0](https://eudi.dev/2.4.0/architecture-and-reference-framework-main/)）。
...
- ARF 2.4.0（[eudi.dev](https://eudi.dev/2.4.0/architecture-and-reference-framework-main/)）と委任規則・実施規則の継続的モニタリング
...
- [EUDI Wallet Architecture Reference Framework 2.4.0 — eudi.dev](https://eudi.dev/2.4.0/architecture-and-reference-framework-main/)
- [GitHub: eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework](https://github.com/eu-digital-identity-wallet/eudi-doc-architecture-and-reference-framework)
