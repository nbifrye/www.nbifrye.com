...
コンテンツを書き終えたら、**このコマンド自身** (`.claude/commands/work.md`) を見直して改善する。

Read ツールで `.claude/commands/work.md` を読み込み、以下の観点で評価する：
...
```bash
# ステージング（コマンド自体を更新した場合は一緒に追加）
git add docs/notes/ .claude/commands/work.md  # または docs/articles/
