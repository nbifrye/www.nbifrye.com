...
IETF OAuth ワーキンググループが策定中であり、2026年2月26日時点で **draft-ietf-oauth-sd-jwt-vc-15** が最新版（Standards Track、IESG レビュー待ち）として公開されています（[IETF Datatracker](https://datatracker.ietf.org/doc/draft-ietf-oauth-sd-jwt-vc/)）。
