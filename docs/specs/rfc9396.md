...
| [RFC 8707](https://www.rfc-editor.org/rfc/rfc8707)                                   | Resource Indicators — `resource` パラメーターで対象リソースを URI 指定（`locations` フィールドと類似の目的） |
...
| [FAPI 2.0](https://openid.net/specs/fapi-security-profile-2_0.html)                  | 金融グレード API プロファイル — PAR 必須・RAR 推奨プロファイル                                               |
