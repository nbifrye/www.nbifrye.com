...
- 2026-02-23: [規制・ガバナンス] 2026-02-23-nist-sp800-63-4.md — NIST SP 800-63-4 最終版（2025年7月）解説。DIRM・PAD 必須化・mDL/VC 受け入れを中心に執筆。日本への直接的影響についての公開情報が限定的で深掘りできず。eIDAS 2.0・FAPI 2.0 Spec 記事・ISO 18013-5 Spec 記事が未カバーのため次回優先候補。
- 2026-02-23: [規制・ガバナンス] 2026-02-23-eidas2-eudi-wallet.md — eIDAS 2.0 義務化タイムライン・ARF 技術スタック・LSP 進捗・民間強制受認（2027年12月）を解説。Wallet 間相互運用性の課題・日EU MoC 締結について触れた。次回優先候補: FAPI 2.0 Spec 記事・ISO 18013-5 Spec 記事・SSF/CAEP Article（エンタープライズ ID 領域が手薄）。
